# -*- coding: utf-8 -*-
"""realestatedataset.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/19Pxi851c_4sgvIksiafSchZ39oXxUKqd
...
from sklearn.metrics import r2_score,mean_squared_error,mean_absolute_error,root_mean_squared_error #evaluation metrics
...
data_new = data.drop(["Distance_to_Center","ID"],axis=1)
data_new
...
n = len(X_l)
np.random.seed(42)
theta = np.random.randn(10,1) # Changed to (10, 1) to match X_l's dimensions for matrix operations 10 rows and 1 column
#theta = [1]
#         2
#         3
#         4
